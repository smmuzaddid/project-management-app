          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 mb-4 flex gap-3">
            ...
            <div>
              ...
              <p className="text-amber-300/70 text-xs mt-1">
                Add your <code className="bg-white/10 px-1 rounded">NEXT_PUBLIC_SUPABASE_URL</code> and{' '}
                <code className="bg-white/10 px-1 rounded">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> to{' '}
                <code className="bg-white/10 px-1 rounded">.env.local</code> to enable authentication.
              </p>
            </div>
          </div>
        )}
